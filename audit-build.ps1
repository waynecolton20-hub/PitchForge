...
Write-Host 'PITCHFORGE SOURCE AUDIT v4.3.0'
...
$checks = @(
    ...
    [pscustomobject]@{ Pass = ($wf -match 'PitchForge-v4\.3\.0-Windows-VST3\.zip'); Name = 'Final v4.3.0 artifact name is consistent' },
